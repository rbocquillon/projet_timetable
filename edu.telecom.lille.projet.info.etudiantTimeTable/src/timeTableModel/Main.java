...
public class Main {
	...
	public static void main(String[] args) {
		...
		//UC.addBooking(1,4,"RB",dated4,datee4,2); ajouter une r�sa, on voit qu'elle s'ajoute bien dans le XML
		//UC.removeBook(1,4); ensuite on la remove, elle disparait bien du XML
		UC.saveDB();
	}
